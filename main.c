...
void loadMap(int mapID, int windowWidth, int windowHeight) {
    ...
    if (mapID == 2) {
        ...
        // Actual Course
        // Blocks
        createBlock( (Vector2){ barrierWidth + 80.0f, windowHeight / 2.0f }, (Vector2){ 30.0f, windowHeight - 100.0f }, 0, GetColor(0x9ec468ff) );
        createBlock( (Vector2){ windowWidth - barrierWidth - 80.0f, windowHeight / 2.0f }, (Vector2){ 30.0f, windowHeight - 100.0f }, 0, GetColor(0x9ec468ff) );
    ...
    if (mapID == 3) {
        ...
        // Actual Course
        // Blocks
        createBlock( (Vector2){ windowWidth / 2.0f, windowHeight / 2.0f }, (Vector2){ 250.0f, 50.0f }, 0, GetColor(0x9ec468ff) );
    ...
    if (mapID == 4) {
        ...
        // Actual Course
        // Blocks
        createBlock( (Vector2){ barrierWidth + 50.0f, windowHeight - 110.0f }, (Vector2){ 90.0f, 220.0f }, 0, GetColor(0x9ec468ff) );
        createBlock( (Vector2){ windowWidth - barrierWidth - 50.0f, windowHeight - 110.0f }, (Vector2){ 90.0f, 220.0f }, 0, GetColor(0x9ec468ff) );

        createBlock( (Vector2){ windowWidth / 2.0f, (windowHeight / 2.0f) - 80.0f }, (Vector2){ 250.0f, 100.0f }, 0, GetColor(0x9ec468ff) );
    ...
    if (mapID == 5) {
        ...
        // Actual Course
        // Blocks
        createBlock( (Vector2){ barrierWidth + 125.0f, (windowHeight / 2.0f) - 170.0f }, (Vector2){ 250.0f, 100.0f }, 0, GetColor(0x9ec468ff) );
        createBlock( (Vector2){ windowWidth - barrierWidth - 40.0f, (windowHeight / 2.0f) - 170.0f }, (Vector2){ 80.0f, 100.0f }, 0, GetColor(0x9ec468ff) );

        createBlock( (Vector2){ barrierWidth + 40.0f, (windowHeight / 2.0f) + 50.0f }, (Vector2){ 80.0f, 100.0f }, 0, GetColor(0x9ec468ff) );
        createBlock( (Vector2){ windowWidth - barrierWidth - 125.0f, (windowHeight / 2.0f) + 50.0f }, (Vector2){ 250.0f, 100.0f }, 0, GetColor(0x9ec468ff) );
    ...
    if (mapID == 6) {
        ...
        // Actual Course
        // Music
        createBlock( (Vector2){ windowWidth / 2.0f, (windowHeight / 2.0f) + 120.0f }, (Vector2){ 250.0f, 80.0f }, 3, GetColor(0xf56c42ff) );
        // Blocks
        createBlock( (Vector2){ barrierWidth + 50.0f, (windowHeight / 2.0f) - 120.0f }, (Vector2){ 90.0f, 50.0f }, 0, GetColor(0x9ec468ff) );
        createBlock( (Vector2){ windowWidth - barrierWidth - 50.0f, (windowHeight / 2.0f) - 120.0f }, (Vector2){ 90.0f, 50.0f }, 0, GetColor(0x9ec468ff) );
    ...
    if (mapID == 7) {
        ...
        // Actual Course
        // Fans
        createBlock( (Vector2){ windowWidth - barrierWidth - 10.0f, (windowHeight / 2.0f) }, (Vector2){ 30.0f, 120.0f }, 5, GetColor(0xf0f0f0ff) );
    ...
    if (mapID == 8) {
        ...
        // Actual Course
        // Fans
        createBlock( (Vector2){ windowWidth - barrierWidth - 10.0f, (windowHeight / 2.0f) + 100.0f }, (Vector2){ 30.0f, 120.0f }, 5, GetColor(0xf0f0f0ff) );
        createBlock( (Vector2){ barrierWidth + 10.0f, (windowHeight / 2.0f) - 100.0f }, (Vector2){ 30.0f, 120.0f }, 4, GetColor(0xf0f0f0ff) );
    ...
    if (mapID == 9) {
        ...
        // Actual Course
        // Blocks
        createBlock( (Vector2){ barrierWidth + 75.0f, (windowHeight / 2.0f) - 180.0f }, (Vector2){ 150.0f, 50.0f }, 0, GetColor(0x9ec468ff) );
        createBlock( (Vector2){ windowWidth - barrierWidth - 75.0f, (windowHeight / 2.0f) - 180.0f }, (Vector2){ 150.0f, 50.0f }, 0, GetColor(0x9ec468ff) );

        createBlock( (Vector2){ barrierWidth + 75.0f, (windowHeight / 2.0f) + 180.0f }, (Vector2){ 150.0f, 50.0f }, 0, GetColor(0x9ec468ff) );
        createBlock( (Vector2){ windowWidth - barrierWidth - 75.0f, (windowHeight / 2.0f) + 180.0f }, (Vector2){ 150.0f, 50.0f }, 0, GetColor(0x9ec468ff) );
        // Fans
        createBlock( (Vector2){ windowWidth - barrierWidth - 10.0f, windowHeight / 2.0f }, (Vector2){ 30.0f, 300.0f }, 5, GetColor(0xf0f0f0ff) );
    ...
    if (mapID == 10) {
        ...
        // Actual Course
        // Fans
        createBlock( (Vector2){ windowWidth / 2.0f, (windowHeight / 2.0f) - 130.0f }, (Vector2){ 250.0f, 40.0f }, 6, GetColor(0xf0f0f0ff) );
        // Blocks
        createBlock( (Vector2){ barrierWidth + 75.0f, (windowHeight / 2.0f) + 150.0f }, (Vector2){ 50.0f, 350.0f }, 0, GetColor(0x9ec468ff) );
        createBlock( (Vector2){ windowWidth - barrierWidth - 75.0f, (windowHeight / 2.0f) + 150.0f }, (Vector2){ 50.0f, 350.0f }, 0, GetColor(0x9ec468ff) );
                        ...
                        if (yCollision) {
                            ...
                            if (xCollision) {
                                ...
                                if (sceneBlocks[i].blockType == 3) {
                                    ...
                                    SetSoundPitch(toneWav, sceneBlocks[i].dimensions.x / 100.0f);
                                    PlaySound(toneWav);

                                    // Cause block to expand
                                    sceneBlocks[i].drawnDimensions.x *= 1.03f;
                                    sceneBlocks[i].drawnDimensions.y *= 1.03f;
                                }
        ...
        for (int i = 0; i < maxBlocks; i++) {
            if (i < nextBlockSpace) {
                ...
                if (sceneBlocks[i].isHole) {
                    ...
                    if (sceneBlocks[i].blockType == 3) {
                        // Note
                        if ((int)sceneBlocks[i].position.x % 2 == 0) {
